...
bool pub_summary_enable = IS_ENABLED(CONFIG_THINGSET_PUB_SUMMARY_DEFAULT);
uint32_t pub_summary_period = CONFIG_THINGSET_PUB_SUMMARY_PERIOD_DEFAULT;
...
THINGSET_ADD_ITEM_BOOL(TS_ID_REP_LIVE, TS_ID_REP_LIVE_ENABLE, "sEnable", &pub_live_data_enable,
                       THINGSET_ANY_RW, TS_SUBSET_NVM);
THINGSET_ADD_ITEM_UINT32(TS_ID_REP_LIVE, TS_ID_REP_LIVE_PERIOD, "sPeriod_s", &pub_live_data_period,
                         THINGSET_ANY_RW, TS_SUBSET_NVM);

THINGSET_ADD_GROUP(TS_ID_REPORTING, TS_ID_REP_SUMMARY, TS_NAME_SUBSET_SUMMARY, NULL);
THINGSET_ADD_ITEM_BOOL(TS_ID_REP_SUMMARY, TS_ID_REP_SUMMARY_ENABLE, "sEnable", &pub_summary_enable,
                       THINGSET_ANY_RW, TS_SUBSET_NVM);
THINGSET_ADD_ITEM_UINT32(TS_ID_REP_SUMMARY, TS_ID_REP_SUMMARY_PERIOD, "sPeriod_s",
                         &pub_summary_period, THINGSET_ANY_RW, TS_SUBSET_NVM);
